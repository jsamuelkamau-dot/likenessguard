...
BASE = 'https://YOUR_API_ID.execute-api.us-east-1.amazonaws.com/v1'
KMS_ARN = 'arn:aws:kms:us-east-1:YOUR_ACCOUNT_ID:key/YOUR_KMS_KEY_ID'
...
os_client = OpenSearch(hosts=[{'host':'YOUR_OPENSEARCH_ID.us-east-1.aoss.amazonaws.com','port':443}], http_auth=auth, use_ssl=True, verify_certs=True, connection_class=RequestsHttpConnection)
