...
| likenessguard-jwks-YOUR_ACCOUNT_ID | S3 + CloudFront | JWKS public key endpoint | Active |
...
import sys, os
sys.path.insert(0, '.')
os.environ['LG_API_ENDPOINT'] = 'https://YOUR_API_ID.execute-api.us-east-1.amazonaws.com/v1'
